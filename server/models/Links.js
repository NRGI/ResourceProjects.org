...
function createDefaultLinks() {
    Link.find({}).exec(function(err, links) {
        if(links.length === 0) {
            ...
            Link.create({_id:'56a8e777777730f50708881e',concession:'56a2b8236e585b7316655794',project:'56a930f41b5482a31231ef43',source:'56747e060e8cc07115200ee6',entities:['project','concession']});
            ...
            Link.create({transfer:'56be54f9d7bff9dd1c93c985',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','transfer']});
            ...
            //production links
            Link.create({production:'56be54f9d7bff9921c93c985',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','production']});
            Link.create({production:'56be54f9d7bff9921c93c986',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','production']});
            Link.create({production:'56be54f9d7bff9921c93c987',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','production']});
            Link.create({production:'56be54f9d7bff9921c93c988',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','production']});
            Link.create({production:'56be54f9d7bff9921c93c989',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','production']});
            Link.create({production:'56be54f9d7bff9921c93c990',project:'56a930f41b5482a31231ef42',source:'56a13a758f224f670e6a376a',entities:['project','production']});
            //country
            //companies
            //project
