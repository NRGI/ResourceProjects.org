...
function createDefaultLinks() {
    Link.find({}).exec(function(err, links) {
        if(links.length === 0) {
            ...
            Link.create({_id:'56a849593445dd0d0817beff',concession:'56a2b8236e585b731665579d',commodity:'56a13e9942c8bef50ec2e9e8',source:'56747e060e8cc07115200ee5',entities:['concession','commodity']});
            Link.create({_id:'56a8e53394857d0d0817beff',concession:'56a2b8236e585b7316655794',commodity:'56a13e9942c8bef50ec2e9e8',source:'56747e060e8cc07115200ee5',entities:['concession','commodity']});
