...
function createDefaultSourceTypes() {
    SourceType.find({}).exec(function(err, source_types) {
        if(source_types.length === 0) {
            ...
            SourceType.create({_id:'56e8733334442a3824141429',source_type_name:'Norway Mandatory payment disclosure',source_type_id:'nodis',source_type_authority:'disclosure',source_type_examples:'Mandatory company disclosure (eg. http://www.detnor.no/wp-content/uploads/2015/03/DETNOR-Annual-Report-2014.pdf?d5b1f2 )',source_type_url_type:'Direct link to data in PDF report'});
            SourceType.create({_id:'56e873691d1d2a3824141428',source_type_name:'EITI report',source_type_id:'eiti',source_type_authority:'authoritative',source_type_examples:'EITI report (eg. https://eiti.org/files/EITI-2010-2011-oil-final.pdf)',source_type_url_type:'Direct link to data in XLS report'});
